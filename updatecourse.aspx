  ...
  <body>
    ...
    <div id="container" class="container">
        ...
        <asp:Button ID="Button1" runat="server" Text="Back" Height="26px" 
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <asp:Button ID="Button2" runat="server" Text="Update" Height="26px" 
        ...
        <td class="style3"><asp:TextBox ID="TextBox2" runat="server" Width="331px"></asp:TextBox></td>
        </tr>
        <tr>
        <td class="style2">Course_Domain: </td>
        <td class="style3"><asp:TextBox ID="TextBox3" runat="server" Width="331px"></asp:TextBox></td>
        </tr>
        <tr>
        <td class="style2">Offered_by: </td>
        <td class="style3"><asp:TextBox ID="TextBox4" runat="server" Width="331px"></asp:TextBox></td>
        </tr>
        <tr>
        <td class="style2">Course_fee: </td>
        <td class="style3"><asp:TextBox ID="TextBox5" runat="server" Width="331px"></asp:TextBox></td>
        </tr>
        <tr>
